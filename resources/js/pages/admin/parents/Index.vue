    ...
    <AppLayout :breadcrumbs="breadcrumbs">  
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto p-4">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold">Parent Management</h1>
                    <p class="mt-1 text-sm text-muted-foreground">
                        Manage all parent members in the system
                    </p>
                </div>
                <Link
                    :href="admin.parents.create().url"
            ...
            <div class="rounded-xl border border-sidebar-border/70 bg-card overflow-hidden dark:border-sidebar-border">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-sidebar-border/70 dark:divide-sidebar-border">
                            <tr v-for="member in parents.data" :key="member.id" class="hover:bg-muted/50">
                    ...
                    <!-- Empty State -->
                    <div v-if="parents.data.length === 0" class="rounded-xl border border-sidebar-border/70 bg-card p-12 text-center dark:border-sidebar-border">
                ...
                <!-- Pagination -->
                <div v-if="parents.links.length" class="border-t border-sidebar-border/70 bg-muted/30 px-4 py-3 dark:border-sidebar-border">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-muted-foreground">
