...
const submit = () => {
    form.post(admin.parents.store().url);
};
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold">Create Parent</h1>
                    <p class="mt-1 text-sm text-muted-foreground">
                        Create parent account and assign to daycares
                    </p>
                </div>
            </div>
                        ...
                        <div class="space-y-3">
                            ...
                            >
                                <Checkbox
                                    ...
                                    :checked="form.daycare_ids.includes(daycare.id)"
