...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: admin.staff.edit({ staff: props.staff.id }).url },
];
...
const form = useForm({
    ...
    password: '',
    phone: props.staff.profile?.phone || '',
    address: props.staff.profile?.address || '',
    city: props.staff.profile?.city || '',
    postal_code: props.staff.profile?.postal_code || '',
    country: props.staff.profile?.country || 'France',
    position: props.staff.profile?.position || '',
    hire_date: props.staff.profile?.hire_date || '',
    daycare_ids: props.staff.associated_daycares.map(daycare => daycare.id) || [] as number[],
});

const submit = () => {
    form.put(admin.staff.update({ staff: props.staff.id }).url);
};
</script>
