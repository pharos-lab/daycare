...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: admin.daycares.create().url },
];
...
const submit = () => {
    form.post(admin.daycares.store().url);
};
</script>

<template>
    <Head title="Create Daycare" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto p-4">
            <!-- Header -->
            <div class="mb-2">
                <h1 class="text-2xl font-bold">Create New Daycare</h1>
                <p class="mt-1 text-sm text-muted-foreground">
                    Add a new daycare to the system
                </p>
            </div>
            ...
            <div class="rounded-xl border border-sidebar-border/70 bg-card dark:border-sidebar-border">
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-sidebar-border/70 dark:border-sidebar-border">
                        ...
                        >
                            {{ form.processing ? 'Creating...' : 'Create Daycare' }}
                        </button>
                    </div>
                </form>
            </div>
